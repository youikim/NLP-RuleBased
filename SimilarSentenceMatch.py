...
class Similar():
    ...
    def __init__(self, as_lib = False):
        ...
        parser.add_argument("-th", default = "0.1" , type = float , help = "threshold 0.1-1.0 ")
        parser.add_argument("-s",  type = str , help = "save_path ")
        parser.add_argument("-name" , type = str , help = "save_name ")
        parser.add_argument("-t", default = "C:/Users/MB207-1/Desktop/8_29/8_27/Yuntech/3a_Rulebased/data/GenerateSentenceList(1).json" , type = str , help = "tranform json file")
        parser.add_argument("-g", default = "C:/Users/MB207-1/Desktop/8_29/8_27/Yuntech/3a_Rulebased/data/ReferenceSentenceList.json" , type = str , help = "Good sentence json file ")
    ...
    def Comparison(self \
                   ...
                   , save_path \
                   , save_name \
                   , GenerateSentenceListPath = "C:/Users/MB207-1/Desktop/8_29/8_27/Yuntech/3a_Rulebased/data/GenerateSentenceList(1).json" \
                   , ReferenceSentenceListPath = "C:/Users/MB207-1/Desktop/8_29/8_27/Yuntech/3a_Rulebased/data/ReferenceSentenceList.json"
                   ):
        ...
        for GenerateSentence in GenerateSentenceListPath:
            for ReferenceSentence in ReferenceSentenceListPath:
                if(self.similarity(GenerateSentence,ReferenceSentence) > self.Similarity_threshold ):
                    print('相似度=',round(self.similarity(GenerateSentence,ReferenceSentence),3),'優良句=',ReferenceSentence,'相似句=',GenerateSentence)
